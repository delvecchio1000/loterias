#!/bin/zsh
##################################################################################
## apostar.sh - Script para loteria Megasena									##
...
##		- Monta o arquivo filtrados.txt contendo os jogos filtrados				##
##		- Filtros utilizados: 												 	##
##			- R12																##
...
##		- Aposta, guardando os jogos no arquivo log_jogos.txt					##
## Requisitos:																	##
##		- Necessita do programa lynx instalado na máquina						##
## Exemplo de uso: ./apostar.sh													##
## Modificações:																##
##		- 30/12/2021: Incluida nova maneira de se obter a posição				##
##			do jogo. Tornou a execução do programa mais rápido					##
##		- 07/01/2022: Alterado o range da retirada de números					## 
## 		aleatórios para 1-60, apenas para fins de teste dos resultados			##
##		(linha 131)																##
##################################################################################
...
#megasena/megasena_0_5.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_5_10.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_10_15.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_15_20.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_20_25.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_25_30.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_30_35.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_35_40.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_40_45.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_45_50.txt /home/junior/Documentos/Meus_scripts/Loterias/\
#megasena/megasena_50_mais.txt | cut -d" " -f1 | cut -d":" -f2)
...
echo "== Apostas para o concurso $prox_concurso da Megasena ==" >> log_jogos.txt
...
#	Alterado o range para 1-60, apenas para fins de teste dos resultados
#	data desta alteração 07/01/2022
shuf -i 1-60 -n 12 > nuns_shuf_R12.txt
...
if [ "$posicao_pen" -lt "$posicao_ult" ] ########## MENORES QUE O ÚLTIMO #####
	...
	if [[ ($posicao_ult -gt 0) && ($posicao_ult -le 5000000) ]]
		...
		megasena/megasena_0_5_impar.txt | grep '\s[234]$' | \
	...
	if [[ ($posicao_ult -gt 5000000) && ($posicao_ult -le 10000000) ]]
		then
		cat /home/junior/Documentos/Meus_scripts/Loterias/megasena/\
		megasena_0_5_impar.txt | grep '\s[234]$' | egrep -v $string \
		| cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
		head -n$posicao_ult /home/junior/Documentos/Meus_scripts/Loterias/\
		megasena/megasena_5_10_impar.txt | grep '\s[234]$' | egrep -v $string \
		| cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
	fi
	...
	if [[ ($posicao_ult -gt 10000000) && ($posicao_ult -le 15000000) ]]
		...
		| cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
		cat /home/junior/Documentos/Meus_scripts/Loterias/megasena/\
		megasena_5_10_impar.txt | grep '\s[234]$' | egrep -v $string \
		| cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
		head -n$posicao_ult /home/junior/Documentos/Meus_scripts/\
		Loterias/megasena/megasena_10_15_impar.txt | grep '\s[234]$' \
		| egrep -v $string | cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
	fi
	...
	if [[ ($posicao_ult -gt 15000000) && ($posicao_ult -le 20000000) ]]
		...
		| cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
		cat /home/junior/Documentos/Meus_scripts/Loterias/megasena/\
		megasena_10_15_impar.txt | grep '\s[234]$' | egrep -v $string \
		| cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
		head -n$posicao_ult /home/junior/Documentos/Meus_scripts/\
		Loterias/megasena/megasena_15_20_impar.txt | grep '\s[234]$' \
		| egrep -v $string | cut -d" " -f1-7 >> /home/junior/Documentos/Meus_scripts/Loterias/megasena/filtrados.txt
	fi
...
echo
echo "Suas $q apostas foram registradas no arquivo log_jogos.txt"
echo "######################### BOA SORTE! #########################"
echo "================================================" >> log_jogos.txt
echo "" >> log_jogos.txt
